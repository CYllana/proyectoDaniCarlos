...
public class UsersScreen extends AbstractScreen  {
	...
	public UsersScreen(MainProyecto main) {
		super(main);
	...
	public void render (float delta){
		...
		lblPassword.draw(batch, "Contrase馻", width / 3,height / 2+txtNombre.getHeight() );		
	...
	public void creacionBtns(){
		...
		float centroY = Gdx.graphics.getHeight() / 2 - btnLogin.getHeight() / 2; // Centro en el eje y de la pantalla centrando el bot贸n
		float centroX = Gdx.graphics.getWidth() / 2 - btnLogin.getWidth()/ 2; // Centro en el eje x de la pantalla centrando el bot贸n		
